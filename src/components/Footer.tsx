        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5">
          <div className="mt-3">
            <Link href="/" className="flex flex-row gap-3 items-center">
              ...
              />
              <div>
                <p className="font-bold font-chango text-green-500 text-xl">
                  DEJAY
                </p>
            ...
            <p className="mt-5 text-sm">
              Professional driving instruction with certified instructors. We
              help you become a confident, safe driver.
            </p>
          ...
          <div className="mt-3">
            <p className="font-semibold font-inter text-lg text-white">
              Quick Links
            </p>
            <div className="mt-5 flex flex-col gap-3">
              ...
              <Link href="/courses" className="hover:text-green-500">
                Courses
              </Link>
          ...
          <div className="mt-3">
            ...
            <p className="mt-5 text-sm">
              Subscribe to our newsletter to get the latest news and updates on
            ...
            <div className="mt-5 flex flex-col">
              <input
                ...
                className="w-full bg-gray-700 rounded-md py-3 px-3 text-sm"
              />
              <Button
                text="Subscribe"
                style="bg-green-500 text-white font-bold py-2 px-5 rounded-md font-inter mt-3 w-full"
              />
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-5 mt-10 ">
        <div className="border-t border-gray-500 gap-5 flex flex-col sm:flex-row justify-between items-start sm:items-center pt-10">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            © {new Date().getFullYear()} DeJay driving school. All rights
            reserved.
          </p>
