    ...
    <div className="Home w-full overflow-hidden">
      <section className="w-full pt-48 min-h-svh flex lg:hidden flex-col justify-end pb-20 bg-gradient-to-t from-green-100 to-white">
        <div className="max-w-6xl mx-auto flex flex-col gap-5 justify-center">
          <div className="px-4">
            ...
            <p className="text-base md:text-2xl md:font-medium text-center mt-2">
              Professional instructors, modern vehicles, and personalized
              lessons to help you become a confident driver.
            </p>
          </div>
          ...
          <div className="flex flex-row gap-5 flex-wrap px-5 md:px-10 justify-center">
            <SimpleButton
              link="/auth/login"
              text="Book Your First Lesson"
              style="bg-green-400 text-sm py-3 px-5 rounded-lg font-inter"
              tesxtStyle="font-semibold"
            />
            <SimpleButton
              link="/tabs/courses"
              text="View Courses"
              style="bg-green-100 text-gray-800 text-sm py-3 px-5 rounded-lg font-inter font-inter"
              tesxtStyle="font-semibold"
            />
          </div>
          <div className="flex flex-row gap-5 flex-wrap mt-6 px-5 items-center justify-center">
            <div className="flex flex-row gap-3 items-center">
              <div className="size-8 bg-gray-800/30 rounded-full flex items-center justify-center">
                <FiCheck className="size-5 text-white" />
              </div>
              <p className="text-sm">Certified Instructors</p>
            </div>
            <div className="flex flex-row gap-3 items-center">
              <div className="size-8 bg-gray-800/30 rounded-full flex items-center justify-center">
                <FiCheck className="size-5 text-white" />
              </div>
              <p className="text-sm">Mordern Vehicles</p>
            </div>
            <div className="flex flex-row gap-3 items-center">
              <div className="size-8 bg-gray-800/30 rounded-full flex items-center justify-center">
                <FiCheck className="size-5 text-white" />
              </div>
              <p className="text-sm">98% Pass Rate</p>
            </div>
          </div>
        </div>
      </section>
      <section className="relative w-full hidden lg:block">
        <div className="relative hero">
          <Image
            src={image.bg2}
            className="img w-full h-full object-bottom"
        ...
        <div className="absolute top-0 right-0 w-full h-full pt-24 pb-5 px-5 md:px-10 ">
          <div className="max-w-6xl mx-auto h-full flex flex-col gap-5 justify-center">
            ...
            <p className="text-base md:text-2xl font-semibold md:font-medium">
              Professional instructors, modern vehicles, and personalized
              lessons to help you become a confident driver.
            </p>
      ...
      <section className="w-full">
        <div className="max-w-6xl mx-auto py-20 px-5 md:py-24">
          <p className="font-bold text-2xl sm:text-3xl text-center">
            Why Choose{" "}
            <span>
              <span className="text-green-500 font-chango">DEJAY</span> Driving
              School
            </span>
          </p>
          <p className="text-center text-gray-600 mt-5">
            We're committed to creating safe, confident drivers through
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {WhyUs.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col gap-3 items-center border-b border-gray-100 py-4"
                >
      ...
      <section className="w-full bg-green-200/10">
        <div className="max-w-6xl mx-auto py-20 px-5 md:py-24">
          ...
          <p className="text-center text-gray-600 mt-5 text-base">
            Whether you're a first-time driver or looking to enhance your
          ...
          <div className="mt-10 w-full flex justify-center items-center">
            <SimpleButton
              ...
              style="w-fit bg-green-500 text-white font-bold py-3 px-5 rounded font-inter"
              tesxtStyle="font-semibold"
            />
          </div>
        </div>
      ...
      <section className="w-full bg-green-200/10">
        <TestimonialCourasel
          ...
          head="What Our Students Say"
        />
      </section>

      <section className="w-full">
        <div className="max-w-7xl mx-auto py-20 px-5 md:py-24">
          <p className="font-extrabold text-2xl sm:text-4xl text-center text-black font-inter">
            Our Learning Process
          </p>
          <p className="text-center text-gray-600 mt-5 text-base md:text-lg font-inter">
            We've designed a straightforward, effective approach to help you
            ...
            {lessonProcess.map((item, index) => (
              <div key={item.id} className="flex flex-col gap-2">
                <div className="size-14 bg-green-500 rounded-full flex justify-center items-center mb-4">
                  <p className="text-white text-center text-2xl font-extrabold font-inter">
                    {item.id}
                  </p>
                </div>
        ...
        <div className="max-w-6xl mx-auto py-20 px-5 md:py-24">
          ...
          <div className="max-w-3xl mx-auto mt-10 flex flex-col gap-5">
            {questions.map((item, index) => (
              <div
                key={item.id}
                className="border-2 border-gray-100 rounded-lg p-5"
              >
